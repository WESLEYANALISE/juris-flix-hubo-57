...
export const QuickAccessSection = () => {
  ...
  return (
    <div className={`bg-card/90 backdrop-blur-sm rounded-xl ${isTablet ? 'p-3 mx-2 mb-4' : 'p-4 sm:p-6 mx-3 sm:mx-4 mb-6'} border border-border/50 text-center shadow-lg glass-effect-modern`}>
      {/* Título */}
